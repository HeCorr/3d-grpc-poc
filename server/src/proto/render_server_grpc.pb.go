...
func _Renderer_RequestRender_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RendererServer).RequestRender(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/render_server.Renderer/RequestRender",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RendererServer).RequestRender(ctx, req.(*RenderRequest))
	}
...
var Renderer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "render_server.Renderer",
	HandlerType: (*RendererServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RequestRender",
			Handler:    _Renderer_RequestRender_Handler,
		},
	},
